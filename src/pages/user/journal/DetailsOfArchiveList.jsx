...
const DetailsOfArchiveList = () => {
  ...
  // Fetch journal issue details and manuscripts
  useEffect(() => {
    const fetchArchiveDetails = async () => {
      try {
        setLoading(true);
        const response = await axios.get(
          `${API_URL}api/published-manuscripts/${j_id}/${v_id}`,
          {
            headers: {
        ...
        if (response.data.flag === 1 && response.data.data) {
          ...
          setError("No data found for this journal issue");
        }
      } catch (err) {
        console.error("Error fetching archive details:", err);
        setError("Failed to load journal issue details");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-10 sm:pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading journal issue details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-10 sm:pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">Journal issue details not available.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-10 sm:pt-24">
      ...
      {/* Filter Section - Only Sort by Date */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-4">
              <select 
                ...
                className="bg-yellow-500 text-white px-4 py-2 rounded-lg font-semibold border-none focus:ring-2 focus:ring-black cursor-pointer"
              >
            ...
            {manuscripts.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">
                  No manuscripts available for this journal issue.
                </p>
              </div>
            )}
          </div>
...
export default DetailsOfArchiveList;
