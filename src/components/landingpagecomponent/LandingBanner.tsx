                        ...
                        <div className=" px-4 h-full flex justify-center items-center  relative z-10">
                            <div className="max-w-2xl text-center">
                                ...
                                <div className="pt-6 border-t border-white/20">
                                    <button className="px-8 py-3 bg-[#ffba00] text-white font-medium rounded-4xl hover:bg-black transition-all duration-300 ease-in-out transform hover:scale-105">
                                        {slide.cta}
                                    </button>
                                </div>
                            </div>
