              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-20">
                ...
                <div className="space-y-4 text-sm text-gray-600">
                  <div className="border-l-4 border-yellow-400 pl-3">
                    ...
                    <p>Submit only original research and content that you have created.</p>
                  </div>
                  
                  <div className="border-l-4 border-blue-400 pl-3">
                    <h4 className="font-semibold text-gray-800">2. Image Requirements</h4>
                    <p>Images should be at least 800x500px in landscape format (aspect ratio 1.3:1 to 2:1). Max size: 5MB.</p>
                  </div>
                  
                  <div className="border-l-4 border-green-400 pl-3">
                    <h4 className="font-semibold text-gray-800">3. PDF Upload (Optional)</h4>
                    <p>Upload a PDF version of your research for detailed reference. Max size: 10MB.</p>
                  </div>
                  
                  <div className="border-l-4 border-purple-400 pl-3">
                    <h4 className="font-semibold text-gray-800">4. Structure</h4>
                    <p>Include a clear title, author name, short description, and detailed content.</p>
                  </div>
                ...
                <div className="mt-6 p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  <div className="flex items-start">
                    ...
                    <p className="text-xs text-yellow-800">
                      <span className="font-semibold">Note:</span> Please ensure all information is accurate and well-researched before submission.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <div className="text-xs text-blue-700 space-y-1">
                    <p>• Title: "The Impact of AI on Modern Healthcare"</p>
                    <p>• Author: Dr. Jane Smith</p>
                    <p>• Category: Technology & Health</p>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Category Selection */}
                  <div>
                    <label htmlFor="blog_category_id" className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Blog PDF <span className="text-gray-400 text-xs">(Optional - Max 10MB)</span>
                    </label>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">Write your full research content with proper formatting</p>
