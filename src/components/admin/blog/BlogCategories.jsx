  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm">
        ...
        <table className="min-w-full w-[700px] divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th
                scope="col"
                className="px-6 py-3 text-center text-xs font-bold text-gray-500 uppercase tracking-wider border-2"
              >
                Action
              </th>
            </tr>
      ...
      <div className="flex items-center justify-between mt-4 text-sm text-gray-600">
        <div>
          Showing {filteredCategory.length > 0 ? 1 : 0} to{" "}
          {filteredCategory.length} of {categories.length} rows
        </div>
      </div>
