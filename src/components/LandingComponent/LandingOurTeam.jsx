...
const LandingOurTeam = ({
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center">
            <div className="animate-pulse flex space-x-4">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="bg-white rounded-lg shadow-lg p-6 w-64">
      ...
      <section className="team-section bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="bg-red-50 border border-red-200 rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <h3 className="text-xl font-bold text-red-800 mb-2">Unable to Load Team</h3>
      ...
      <section className="team-section bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="bg-white rounded-lg shadow-sm p-12 max-w-2xl mx-auto">
            ...
            <h3 className="text-2xl font-bold text-gray-700 mb-2">Meet Our Team</h3>
  ...
  return (
    <section className="team-section bg-gradient-to-br from-gray-50 to-blue-50 py-6 md:py-20">
      <div className="container mx-auto px-4">
        {/* Section Header */}
        <div className="text-center mb-8 md:mb-16">
          ...
          <h5 className="text-xl text-gray-600 max-w-3xl mx-auto">
            Dedicated professionals committed to excellence in scientific publishing and innovation
          </h5>
        </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden group">
                    ...
                    <div className="relative overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = `https://via.placeholder.com/400x400/4F46E5/FFFFFF?text=${encodeURIComponent(name.charAt(0))}`;
                        }}
                      />
