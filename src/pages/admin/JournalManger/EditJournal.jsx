...
const EditJournal = () => {
    ...
    const handleChange = (e) => {
            ...
            if (file) {
                ...
                img.onload = function () {
                    ...
                    if (aspectRatio < 1.3 || aspectRatio > 2.0) {
                        setErrors((prev) => ({
                            ...prev,
                            image: `Recommended aspect ratio is between 1.3:1 and 2:1. Current: ${(width / height).toFixed(
                                2
                            )}:1`,
                        }));
        ...
        } else if (["issn_print", "issn_online", "ugc_approved", "status"].includes(name)) {
    ...
    const handleSubmit = async (e) => {
        ...
        const numericFields = ["impact_factor", "acceptance_rate", "h_index", "amount"];
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            {errors.impact_factor && (
                                <p className="text-red-500 text-sm mt-1">{errors.impact_factor}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.total_articles && (
                                <p className="text-red-500 text-sm mt-1">{errors.total_articles}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.total_citations && (
                                <p className="text-red-500 text-sm mt-1">{errors.total_citations}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.acceptance_rate && (
                                <p className="text-red-500 text-sm mt-1">{errors.acceptance_rate}</p>
                            )}
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full border px-3 py-2 rounded ${
                            errors.issn_print_no ? "border-red-500" : ""
                        }`}
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full border px-3 py-2 rounded ${
                            errors.issn_online_no ? "border-red-500" : ""
                        }`}
