          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {(userData?.user_type === "0" || userData?.user_type === "1") &&
                <SidebarLinkGroup activecondition="permission">
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <a
                          href="#0"
                          className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname.includes("permission") ? "" : "hover:text-gray-900 dark:hover:text-white"
                            }`}
                          onClick={(e) => {
                            e.preventDefault();
                            handleClick();
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg className={`shrink-0 fill-current ${pathname.includes('permission') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                          ...
                          <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                            ...
                            <li className="mb-1 last:mb-0">
                              <NavLink
                                ...
                                to="/articlemanager/view-manuscript"
                                className={({ isActive }) =>
                                  "block transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                                }
                              >
              ...
              {userData?.user_type === "0" &&
                <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname === "/payment" && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                  <NavLink
                    end
                    to="/payment"
                    className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname === "/payment" ? "" : "hover:text-gray-900 dark:hover:text-white"
                      }`}
                  >
                    <div className="flex items-center">
                      <svg className={`shrink-0 fill-current ${pathname === "/payment" ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM4.5 11.5a3.5 3.5 0 0 1 7 0 .5.5 0 0 1-.5.5h-6a.5.5 0 0 1-.5-.5Z" />
                        <path d="M1 4.5a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-6Zm1 0v6h12v-6H2Z" />
                      </svg>
                      <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
              ...
              {userData?.user_type === "0" &&
                <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname === "/email-setting" && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                  <NavLink
                    end
                    to="/email-setting"
                    className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname === "/email-setting" ? "" : "hover:text-gray-900 dark:hover:text-white"
                      }`}
                  >
                    <div className="flex items-center">
                      <svg className={`shrink-0 fill-current ${pathname === "/email-setting" ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM4.5 11.5a3.5 3.5 0 0 1 7 0 .5.5 0 0 1-.5.5h-6a.5.5 0 0 1-.5-.5Z" />
                        <path d="M1 4.5a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-6Zm1 0v6h12v-6H2Z" />
                      </svg>
                      <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
              ...
              {userData?.user_type === "3" &&
                <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname === "journals" && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                  <NavLink
                    end
                    to="/list-journals"
                    className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname === "journals" ? "" : "hover:text-gray-900 dark:hover:text-white"
                      }`}
                  >
                    <div className="flex items-center">
                      <svg className={`shrink-0 fill-current ${pathname === "journals" ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM4.5 11.5a3.5 3.5 0 0 1 7 0 .5.5 0 0 1-.5.5h-6a.5.5 0 0 1-.5-.5Z" />
                        <path d="M1 4.5a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-6Zm1 0v6h12v-6H2Z" />
                      </svg>
                      <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
