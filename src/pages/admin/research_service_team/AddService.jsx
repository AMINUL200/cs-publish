    ...
    try {
      ...
      if (res.data.status) {
        ...
        setFormData({
          ...
          linkedin_link: service.linkedin_link || "",
      ...
      toast.error(
        err.response?.data?.message || "Error fetching service data"
      );
    } finally {
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  {isEditMode
                    ...
                    : "Create a new service with all necessary details"}
                </p>
              </div>
              <div
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Upload a representative image for your service (optional)
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  type="button"
                  onClick={() => navigate("/setting/service")}
