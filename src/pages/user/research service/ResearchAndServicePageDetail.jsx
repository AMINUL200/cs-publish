  ...
  const workflowSteps = [
    {
      ...
      description:
        "Authors submit their manuscript through our secure platform with all required documents and metadata.",
      icon: Send,
      details: [
    ...
    },
    {
      ...
      description:
        "Our editorial team reviews the submission and assigns qualified reviewers based on expertise.",
      icon: UserCheck,
      details: [
    ...
    },
    {
      ...
      description:
        "Expert reviewers conduct thorough evaluation and provide comprehensive feedback.",
      icon: Eye,
      details: [
    ...
    },
    {
      ...
      description:
        "Secure payment processing before final publication with flexible payment options.",
      icon: CreditCard,
      details: [
    ...
    },
    {
      ...
      description:
        "Publication with DOI assignment, indexing, and global distribution.",
      icon: Globe,
      details: [
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 pt-4">
        {/* Header Section */}
        <div
          className={`relative overflow-hidden bg-gradient-to-r ${currentService.color}`}
        >
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div className="flex items-center text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-4 h-4 ${i < Math.floor(currentService.rating) ? "fill-current" : ""}`}
                      />
                    ))}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="lg:sticky lg:top-8">
                  <div
                    className={`bg-gradient-to-br ${workflowSteps[currentStep].color} rounded-2xl p-8 text-white`}
                  >
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        <div className="text-sm opacity-90">
                          Step {workflowSteps[currentStep].step} of{" "}
                    ...
                    <div className="space-y-3">
                      ...
                      {workflowSteps[currentStep].details.map(
                        (detail, index) => (
                          <div key={index} className="flex items-start">
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {currentService.benefits.map((benefit, index) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${currentService.color} rounded-xl flex items-center justify-center mb-4`}
                    >
              ...
              <div
                className={`bg-gradient-to-r ${currentService.color} rounded-2xl p-8 text-white`}
              >
                <div className="text-center">
            ...
            <div className="space-y-12">
              ...
              <div className="text-center bg-gray-50 rounded-2xl p-8">
                ...
                <h5 className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Contact our team for enterprise solutions, bulk projects, or
                  specialized requirements. We offer flexible pricing for
        ...
        <div className={`bg-gradient-to-r ${currentService.color} py-16`}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join thousands of researchers who trust our platform for their
              manuscript management needs
            </p>
